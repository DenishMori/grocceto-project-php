<script>
    function updateStatus(pizzaId) {
        var form = document.getElementById("statusForm" + pizzaId);
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                var switchSlider = document.querySelector("#statusForm" + pizzaId + " .switch-slider");
                if (response === "on") {
...
<div class="container-fluid" style="margin-top:98px">
			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-footer">
						<div class="row">
							<div class="mx-auto">
								<button type="submit" name="createItem" class="btn btn-sm btn-secondary"> Create </button>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover mb-0">
							...
							<?php
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									if(isset($_POST['status'.$pizzaId])) {
										$status = ($_POST['status'.$pizzaId] == 'on') ? 1 : 0;
										$updateSql = "UPDATE `pizza` SET `status` = '$status' WHERE `pizzaId` = '$pizzaId'";
    ...
    echo '<tr>
            ...
            <td>
                <img src="/groceryshop/img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">
            </td>
            <td>
            ...
            <td class="text-center">
				...
				<form action="" method="POST" id="statusForm'.$pizzaId.'">
					<input type="hidden" name="status'.$pizzaId.'" value="'.($status == 1 ? "off" : "on").'">
					<button type="submit" onclick="updateStatus(<?=$pizzaId?>) class="toggle-button ">
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/groceryshop/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
