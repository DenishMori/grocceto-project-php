...
<html lang="en">
  <head>
    ...
    <title>Home</title>
    <link rel = "icon" href ="img/logog.jpg" type = "image/x-icon">
...
<?php include 'partials/_dbconnect.php';?>
  ...
  <img src="img/h.jpg"  alt="BannerImage" Height="400" width="100%">
  ...
  <style>
    ...
    <h1 class="title" align="center">category</h1>
      <img src="img/vegitableandfruit.jpg" width="20%" img-align="center">
      </div>
      <h3>Fruits and vegitables</h3>
      <p>In a botanical sense, a fruit is the fleshy or dry ripened ovary of a flowering plant, enclosing the seed or seeds.</p>
  ...
  <!-- <h2 class="text-center">Products</h2> -->
    ...
    <script src="https://unpkg.com/bootstrap-show-password@1.2.1/dist/bootstrap-show-password.min.js"></script>
      ...
      <h2><p class="credit" align="center"> <span>GROCCETTO FOR YOUR HELTHY FOOD!</h2></span>  </p>
</body>
</html>
